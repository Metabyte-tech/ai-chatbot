...
const SAMPLES = [
    "Find CE-certified night light suppliers",
    "Looking for mask suppliers with low MOQ",
    "Recommend waterproof and soft materials for outdoor baby gear",
];
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8 max-w-3xl mx-auto w-full">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <p className="text-zinc-700 text-sm leading-relaxed">
                        ...
                        {" "}— I'll hunt through <strong>Alibaba.com</strong> and <strong>Global sites</strong> to match you with top-tier suppliers.
                    </p>
                        ...
                        <div className="flex flex-col gap-2">
                            {SAMPLES.map((sample) => (
                                <button
                                    ...
                                    className="flex items-start gap-3 rounded-xl border border-zinc-100 bg-white px-4 py-3 text-left text-sm text-zinc-700 transition-all hover:border-blue-200 hover:bg-blue-50/50 hover:shadow-sm group"
                                >
                                    <CornerDownLeft className="mt-0.5 h-3.5 w-3.5 shrink-0 text-zinc-300 group-hover:text-blue-400 transition-colors" />
                                    {sample}
                                </button>
                            ))}
                        </div>
